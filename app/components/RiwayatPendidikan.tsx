...
function RowRiwayat (props:any) {
    return (
      <div className="border-2 border-indigo-500/75 rounded-1g ☐ bg-yellow-800 p-2 my-5">
...
<RowRiwayat jenjang="SD" sekolah="SDN MARUYUNG 1" tahun="2011" />
<RowRiwayat jenjang="SMP" sekolah="SMPN 1 TANJUNGSARI" tahun="2014" />
<RowRiwayat jenjang="SMA" sekolah="SMAN TANJUNGSARI" tahun="2021" />
